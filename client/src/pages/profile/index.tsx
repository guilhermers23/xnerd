...
export const Profile = () => {
  ...
  const { data: posts, isError: postsError } =
    useGetMePostsQuery(queryUsername);
  ...
  return (
    <Styled.Section>
        ...
        <>
          ...
          >
            <MeProfile
              ...
              is_following={loggedInUser.is_following}
              cover_url={loggedInUser.cover_url}
      ...
      <Cabecalho style={{ borderRight: 'none', borderLeft: 'none' }}>
        Suas postagens
      </Cabecalho>
